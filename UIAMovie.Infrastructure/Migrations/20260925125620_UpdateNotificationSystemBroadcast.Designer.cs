...
namespace UIAMovie.Infrastructure.Migrations
{
    ...
    [Migration("20260925125620_UpdateNotificationSystemBroadcast")]
    partial class UpdateNotificationSystemBroadcast
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UIAMovie.Domain.Entities.Advertisement", b =>
                {
                    ...
                    b.Property<string>("BrandImageCloudinaryPublicId")
                        .HasMaxLength(200)
                    ...
                    b.Property<int?>("SkipAfterSeconds")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UIAMovie.Domain.Entities.Movie", b =>
                {
                    ...
                    b.HasIndex("IsPremium", "IsPublished");

                    b.HasIndex("ReleaseDate", "ImdbRating");
            ...
            modelBuilder.Entity("UIAMovie.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Is2FaEnabled = false,
                            IsActive = true,
                            PasswordHash = "$2a$11$K/2Q1ANLl98y4BU0wLBEQuf8GBRO8yXnY0Gdm2BW/jFtU7k/My5yS",
                            Role = "Admin",
