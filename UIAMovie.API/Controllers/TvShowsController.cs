...
public class TvShowsController : ControllerBase
{
    ...
    public async Task<IActionResult> UploadTrailerVideo(Guid id, IFormFile trailerFile)
    {
        ...
        var url = await _cloudinaryService.UploadVideoAsync(trailerFile, $"uiamovie/tvshows/{id}/trailer");
    ...
    public async Task<IActionResult> SetTrailerYoutube(Guid id, [FromBody] SetTrailerYoutubeDTO dto)
    {
        ...
        var success = await _tvShowService.SetTrailerYoutubeAsync(id, dto.YoutubeUrl);
        return success
